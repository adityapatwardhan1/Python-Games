...
class Drawable:
    ...
    def draw(self, surface_object):
        ...
        for i in range(len(self.coordinate_list)):
            ...
            pygame.draw.rect(surface_object, color, (25 * coordinate[0], 25 * coordinate[1], 25, 25))  # Squares 25
            # pixels wide
...
class Game:
    ...
    def run(self):
        ...
        while True:
            ...
            end_game_if_snake_died(self.snake, self.board)
            time.sleep(0.11)  # Controls the speed of the game
            self.board.draw(win)
